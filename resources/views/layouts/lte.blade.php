...
<div class="wrapper" id="corner">
    ...
    <footer class="main-footer">
          ...
          <strong>Copyright &copy; 2018-<?= date('Y')?> <a href="https://squarem.com.ng">Squarem Information Communications Systems</a>.</strong> All rights reserved.
    </footer>
</div>
