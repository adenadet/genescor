                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center user-info">
                            <img :src="'/img/profile/'+user.image" width="300" height="auto" alt="avatar">
                            <p class=""></p>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="bio-data">
                                <UserForm :areas="areas" :branches="branches" :states="states" :user="user"></UserForm>
                            </div>
                            <div class="tab-pane" id="next-of-kin">
                                <UserNOKForm :nok="nok"></UserNOKForm>
                            </div>
