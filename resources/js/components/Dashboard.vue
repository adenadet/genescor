                        ...
                        <table class="table table-hover m-b-0">
                            ...
                            <tbody>
                                <tr v-for="loan in loans" :key="loan.id">
                                    ...
                                    <td v-if="loan.status == 0"><span class="badge badge-warning">Pending</span></td>
                                    <td v-else-if="loan.status == 1"><span class="badge badge-primary">Active</span></td>
                                    <td v-else-if="loan.status == 2"><span class="badge badge-success">Completed</span></td> 
                                    <td v-else-if="loan.status == 3"><span class="badge badge-success">Cancelled</span></td> 
                                </tr>
                            </tbody>
                        </table>
                    </div>
