...
<div class="table-responsive">
    <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
        <thead>
            <tr>
                <th>Cooperator: </th>
                <th colspan=3>{{account != null && typeof account.user != "undefined" && account.user != null ? account.user.first_name+' '+account.user.last_name : ''}}</th>
                <th>Branch</th>
                <th>{{account != null && typeof account.branch != "undefined" && account.branch != null ? account.branch.name : ''}}</th>
            </tr>
            <tr>
                <th>Balance: </th>
                <th>&#x20a6; {{account != null && typeof account.user != "undefined" && account.user != null ? account.balance: 0 |currency}}</th>
                <th>Fixed</th>
                <th>&#x20a6; {{account != null && typeof account.user != "undefined" && account.user != null ? account.fixed: 0}}</th>
                <th>Total</th>
                <th>&#x20a6; {{account != null && typeof account.user != "undefined" && account.user != null ? account.balance: 0}}
                </th>
            </tr>
        </thead>
    </table>
    <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
        ...
        <tbody v-if="typeof account != 'undefined' &&  typeof account.contributions != 'undefined' && account.contributions.length() > 0">
        ...
        <tbody v-else>
            <tr>
                <td colspan=6>This Cooperator has no contributions yet</td>
            </tr>
        </tbody>
    </table>
</div>
