...
<form @submit.prevent="editMode ? updateGuarantor() : createGuarantor() ">    
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
            ...
            <input class="form-control" type="text" :value="saving ? (saving.balance - saving.fixed).toFixed(2) : 0.00" disabled />
            </div>
        </div>
        <div class="col-md-6 col-sm-6">
            <div class="form-group">
            <label>Guarantee Sum</label>
            <input type="number" class="form-control" name="amount" id="amount" placeholder="Enter Amount Paid" required v-model="form.amount" :max="saving ? (saving.balance - saving.fixed) : 0">
            </div>
        </div>
        <div class="col-md-12 col-sm-12">
