...
<div class="row">
    <div class="col-md-6 col-sm-12">
        <div class="form-group">
            <label>Branch</label>
            <select class="form-control" id="branch_id" name="branch_id" v-model="form.branch_id" @change="selectUser" required>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="form-group">
            ...
            <select class="form-control" id="user_id" name="user_id" v-model="form.user_id" @change="selectSavings" required>
...
<script>
    export default {
        ...
        methods:{
            ...
            selectSavings() {
                this.savings = this.users[this.form.user_id].savings;
            },
