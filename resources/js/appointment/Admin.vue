        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <AppointmentFormRequest :appointment="appointment"/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="all">
                        <table class="table table-striped">
                            <thead><tr><th>Date</th><th>Preferred Time</th><th>Fixed Time</th><th>Patient</th><th>Doctor</th><th>Room </th><th>Status</th><th></th></tr></thead>
                            <tbody v-show="appointments != null">
                                ...
                                <td>{{appointment.patient != null ? appointment.patient.first_name+' '+appointment.patient.last_name : 'Patient has closed account'}}</td>
